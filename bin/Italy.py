...
if __name__ == '__main__':
    ...
    terrain_modeler = pyterrainmodeler.terrain_modeler.TerrainModeler(latitude=36.206,  # Deg N/S for the SW corner
                                                                      longitude=11.811,  # Deg W/E for the SW corner
                                                                      longitude_size=(19.219 - 11.811),  # SE corner longitude - SW corner longitude
                                                                      ...
                                                                      offset_elevation=-300,  # If 0 is sea level, then the water areas of the model have no "base" and you print just the land on the build plate.
                                                                      ...
                                                                      flatten_reference_elevation_meters=-22,  # This was a turning.
